        ...
        <div class="sec-two">
            ...
            <div class="page">
               <div class="loginpg">
                        ...
                        <div class="optionE">
                         <a href="webname" class="optionK" style="text-decoration: none;">   <h4 style="color: white;">
                                Website Edit 
                            </h4></a>
                        </div>
                        <div class="optionE">
                            <a href="contentname" class="optionK" style="text-decoration: none;">     <h4 style="color: white;">
                                Content Pages Edit
                            </h4></a>
                        </div>
